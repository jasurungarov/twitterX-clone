        ...
        <div>
          <div className="flex flex-row items-center gap-2">
            ...
            <span className="text-neutral-500 text-sm">
              {/* {formatDistanceToNowStrict(new Date(post.createdAt))} ago */} ago
            </span>
          </div>
          ...
          <div className="flex flex-row items-center mt-3 gap-10">
            ...
            <div
              className={`flex flex-row items-center text-neutral-500 gap-2 cursor-pointer transition hover:text-red-500`} onClick={onLike}
            >
